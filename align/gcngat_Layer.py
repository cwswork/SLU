...
class GCNGAT_Layer(nn.Module):
    def __init__(self, kgs_data, myconfig):
        super(GCNGAT_Layer, self).__init__()
        ...
        ######## GAT
        self.gat_Linear = nn.Linear(myconfig.input_dim, myconfig.out_dim) # Linear
    ...
    def gcn_layer(self, ent_embed):
        ...
        neigh_sum = self.special_spmm(self.edge_index, self.edge_weight, (self.KG_E, self.KG_E), ent_embed)
        ...
        gcn_out = ((ent_embed + neigh_sum) / (1. + rowsum))
